  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CartItemsCubit, CartItemsState>(
      buildWhen: (previous, current) {
        if (current is CartItemsUpdated) {
          if (current.cartItemEntitey == cartItemEntitey) {
            return true;
          }
        }
        return false;
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  Text(
                    ...
                    style:
                        TextStyless.bold13.copyWith(color: Color(0xff06161C)),
                  ),
                  SizedBox(
                    height: 6,
                  ),
                  ...
                  QuantityCounter(
                    cartItemEntitey: cartItemEntitey,
                  )
                ],
              ),
              Spacer(),
              Column(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      context.read<CartCubit>().RemoveCartItem(cartItemEntitey);
                    },
